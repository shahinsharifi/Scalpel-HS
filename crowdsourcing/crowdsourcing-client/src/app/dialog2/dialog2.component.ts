...
export class Dialog2Component implements OnInit, AfterViewInit  {
  ...
  constructor(public dialogRef: MatDialogRef<Dialog2Component>, @Inject(MAT_DIALOG_DATA) public data: DialogData,
